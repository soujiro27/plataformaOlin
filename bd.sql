...
create table DireccionesNegocios(
	idDireccionNegocio int auto_increment primary key,
...
insert into Usuarios(nombre, password, tipo)values('01admin01','.admin01.',0);